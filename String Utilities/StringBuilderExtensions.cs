...
namespace String_Utilities
{
    public static class StringBuilderExtensions
    {
        ...
        public static StringBuilder Replace(this StringBuilder source, string replacement)
        {
            ...
            string replaced = Regex.Replace(source.ToString(), @"\s+", replacement);
        ...
        /// </summary>
        /// <param name="predicate">Your prediacate function</param>
        /// <returns></returns>
        ...
        public static int IndexOf(this StringBuilder source, StringBuilder value)
        {
            ...
            int maxSearchLength = (source.Length - length) + 1;
